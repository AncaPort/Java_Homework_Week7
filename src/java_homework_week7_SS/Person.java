...
public class Person {
    ...
    public String getFirstName() {//method 1 to get first name
        return firstName;
    }

    public String getLastName() {//method 2 to get last name
        return lastName;
    }

    public int getAge() {//method 3 to get age
        return age;
    }

    public void setFirstName(String firstName) {//method 4 to set first name
        this.firstName = firstName;
    }

    public void setLastName(String lastName) {//method 5 set lastname
        this.lastName = lastName;
    }

    public void setAge(int age) {//method 6 set age
        if (age >= 0 && age <= 100) {
            this.age = age;
        } else {
            this.age = 0;
    ...
    public boolean isTeen() {//method 7 to check if person is teen
        return (age > 12 && age < 20);
    }

    public String getFullName() {//method 8 get fullname
